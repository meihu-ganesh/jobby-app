...
class AllJobs extends Component {
  ...
  onGetProfileDetails = async () => {
    ...
    const profileAppiUrl = 'https://apis.ccbp.in/profile'
    ...
    const responseProfile = await fetch(profileAppiUrl, optionsProfile)
  ...
  onGetJobDetails = async () => {
    ...
    if (responseJobs.ok === true) {
      ...
      const updatedDataJobs = fetchedDatajobs.jobs.map(eachJob => ({
  ...
  onGetProfileFailureView = () => (
    <div className="failure-button-contaainer">
      <button
